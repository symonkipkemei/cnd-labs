...
with open("desktop_status.csv", "a") as ds:
    #create a write object
    csv.DictWriter
    # establish the field names and store in a list
    field_names = []
    ...
    print(field_names)
    # write the header
    writer_object = csv.DictWriter(ds, fieldnames=field_names)
    writer_object.writeheader()
    
    # write to the csv
    writer_object.writerow(new_dict)
